...
class Brain:
    ...
    def __init__(self, vision_resolution, max_distance):
        ...
        self.distance_neural_network = NeuralNetwork(int(vision_resolution)*5+3, 5, [32, 64, 64, 32, 1], (-1, 1))
        self.angle_neural_network = NeuralNetwork(int(vision_resolution)*5+3, 5, [32, 64, 64, 32, 1], (-1, 1))
